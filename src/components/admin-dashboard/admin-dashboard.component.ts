...
import { AdminService, AdminView } from '../../services/admin.service';
...
export class AdminDashboardComponent {
  ...
  saveSettings(): void {
    ...
    // In a real app, you would securely save dbUrl and dbApiKey.
    console.log('Saving DB URL:', this.dbUrl());
    console.log('Saving DB API Key:', this.dbApiKey());

    this.settingsMessage.set('Configurações salvas com sucesso!');
